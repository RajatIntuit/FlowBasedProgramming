...
exports.options = { transformation: '{}', enabled: true, enable_disable: true, reset: true, debug: true, errors: false };
exports.readme = 
`# Condition: Transform
Allows arbitrary transformation of in message before passing to out channel (basically EEL as a component).
...
name	transformation
type	object
doc	eel style transformation for payload or props
default	
required	yes
valid values	
`;
...
`<div class="padding">
	...
	<div class="col-md-4 m">
		<div data-jc="codemirror" data-jc-path="transformation" data-jc-config="placeholder:@({});type:javascript" class="m">Transformation</div>
	</div>
</div>`;

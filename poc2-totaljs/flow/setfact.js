...
exports.options = { key: '', value: '{}', enabled: true, enable_disable: true, reset: true, debug: true, errors: false };
exports.readme = 
`# Condition: SetFact
...
`<div class="padding">
	...
	<div class="col-md-4 m">
		<div data-jc="codemirror" data-jc-path="value" data-jc-config="placeholder:@({});type:javascript" class="m">Value</div>
	</div>
</div>`;

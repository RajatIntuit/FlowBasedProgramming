exports.id = 'generate_notification';
exports.title = 'GenerateNotification';
...
exports.options = { notification_message: '', notification_title: '', enabled: true, enable_disable: true, reset: true, debug: true, errors: false };
exports.readme = 
`# Condition: GenerateNotification
Generates an arbitrary notification message and title string based on parameters collected from the in message and injects them into the props section of the message before forwarding on the out channel.
...
type	string
doc	notification string, references to payload and props using moustache notation allowed
default	
required	yes
valid values	
...
type	string
doc	title string, references to payload and props using moustache notation allowed
default	
required	yes
valid values	
`;
...
`<div class="padding">
	...
	<div class="row">
		<div class="col-md-4 m">
			<div data-jc="textbox" data-jc-path="notification_message" data-jc-config="placeholder:@()" class="m">Notification Message</div>
		</div>
		<div class="col-md-4 m">
			<div data-jc="textbox" data-jc-path="notification_title" data-jc-config="placeholder:@()" class="m">Notification Title</div>
		</div>
	</div>	
</div>`;

...
exports.options = { start: 'dd.MM.yyyy HH:mm:ss', end: 'dd.MM.yyyy HH:mm:ss', enabled: true, enable_disable: true, reset: true, debug: true, errors: false };
exports.readme = 
`# Condition: Time
If current time matches configured time frame, in message will be passed to out channel unharmed, otherwise in message will be dropped.
...
name	start
type	time
doc	start time of legal time frame
default	
required	yes
valid values	
...
name	end
type	time
doc	end time of legal time frame
default	
required	yes
valid values	
`;
...
`<div class="padding">
	...
	<div class="col-md-4">
		<div data-jc="textbox" data-jc-path="start" data-jc-config="placeholder:@(dd.MM.yyyy HH:mm:ss);maxlength:25;align:center">Start</div>
	</div>
	<div class="col-md-4">
		<div data-jc="textbox" data-jc-path="end" data-jc-config="placeholder:@(dd.MM.yyyy HH:mm:ss);maxlength:25;align:center">End</div>
	</div>
</div>`;

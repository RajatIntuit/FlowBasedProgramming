exports.id = 'repeat';
exports.title = 'Repeat';
exports.group = 'Gears-Condition';
exports.color = 'LightGreen';
exports.icon = 'fa-thermometer-half';
exports.input = ['green', 'red'];
exports.output = ['blue'];
exports.version = '1.0.0';
exports.author = 'Xfinity Gears';
exports.options = { iterations: 1, interval: '1s', timer_id: '', enabled: true, enable_disable: true, reset: true, debug: true, errors: false };
exports.readme = 
`# Condition: Repeat
The activate message will be passed to the out channel iterations times with a delay interval, unless an (arbitrary) message is received on the cancel channel. timer_id, if provided, is used as ID for the internal timer ID, example: payload.meta.id
...
name	interval
type	string
doc	pause between interations, for example 1s, 1h
default	
required	yes
valid values	
...
name	timer_id
type	string
doc	hint for choice of timer id, for example payload.meta.id
default	
required	yes
valid values	
`;
...
`<div class="padding">
	...
	<div class="row">
		<div class="col-md-4 m">
			<div data-jc="textbox" data-jc-path="timer_id" data-jc-config="placeholder:@()" class="m">Timer Id</div>
		</div>
	</div>	
	<div class="col-md-4 m">
		<div data-jc="textbox" data-jc-path="iterations" data-jc-config="placeholder:1;type:number;increment:true" class="m">Iterations</div>
	</div>
	<div class="col-md-4 m">
		<div data-jc="textbox" data-jc-path="interval" data-jc-config="placeholder:@(1s) class="m">Interval</div>
	</div>
</div>`;

...
exports.options = { endpoint: '', method: '', headers: '{}', enabled: true, enable_disable: true, reset: true, debug: true, errors: false };
exports.readme = 
`# Condition: Http
Performs arbitrary http request triggered by in message. Response body, status and status code are added to the message props before forwarding on out channel. If the request results in error, the message is emiited on the error channel rather than the out channel.
...
`<div class="padding">
	...
	<div class="row">
		<div class="col-md-4 m">
			<div data-jc="textbox" data-jc-path="endpoint" data-jc-config="placeholder:@()" class="m">EndPoint</div>
		</div>
	</div>	
	<div class="col-md-4 m">
		<div data-jc="textbox" data-jc-path="method" data-jc-config="placeholder:@()" class="m">Method</div>
	</div>
	<div class="col-md-4 m">
		<div data-jc="codemirror" data-jc-path="temp_heating_away" data-jc-config="placeholder:@();type:javascript" class="m">Headers</div>
	</div>
</div>`;

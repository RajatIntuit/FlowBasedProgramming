exports.id = 'deletefact';
exports.title = 'Deletefact';
...
exports.readme = 
`# Condition: DeleteFact
Delete a fact from the local in-memory fact store and forward the in message on the out channel.
...
name	key
type	string
doc	key of crew fact to delete
default	
required	yes
valid values	
`;

...
exports.options = { payload: '{}', props: '{}', enabled: true, enable_disable: true, reset: true, debug: true, errors: false };
exports.readme = 
`# Condition: Data
Join data parameter with in message and forward on out channel. Choose whether to merge with message payload or message props based on boolean parameters.
...
name	payload
type	object
doc	data to add to payload of message
default	
required	no
valid values	
...
name	props
type	object
doc	data to add to props of message
default	
required	no
valid values	
`;

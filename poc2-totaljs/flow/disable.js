...
exports.options = { enabled: true, enable_disable: true, reset: true, debug: true, errors: false };
exports.readme = 
`# Condition: Disable
A component that sends a disable signal to all components in the flow.

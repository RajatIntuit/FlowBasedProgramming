exports.id = 'calculate';
exports.title = 'Calculate';
...
exports.options = { formula: 'var x = y + 1', enabled: true, enable_disable: true, reset: true, debug: true, errors: false };
exports.readme = 
`# Condition: Calculate
Performs arbitrary calculation on message payload or message properties. Calculation should be provided as formula parameter in JavaScript syntax. Example: props.dim_level = 10*(props.iteration+1)
...
name	formula
type	string
doc	formula as evaluable JavaScript string; references to payload and or props are alowed
default	
required	yes
valid values	
`;
...
`<div class="padding">
	...
	<div class="row">
		<div class="col-md-4 m">
			<div data-jc="codemirror" data-jc-path="formula" data-jc-config="placeholder:@(var x = y + 1);type:javascript" class="m">Formula</div>
		</div>
	</div>	
</div>`;

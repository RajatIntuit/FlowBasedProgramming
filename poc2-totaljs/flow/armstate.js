...
exports.readme = 
`# Condition: ArmState
In message will be forwarded unchanged on out channel if arm state is one of the states listed in the armstate parameter.
...
default	
required	no
valid values	[disarmed armed armedaway]
`;

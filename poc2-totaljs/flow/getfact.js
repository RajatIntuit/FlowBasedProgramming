...
exports.options = { key: '', enabled: true, enable_disable: true, reset: true, debug: true, errors: false };
exports.readme = 
`# Condition: getfact
Get a fact from the local in-memory fact store and forward it on the out channel. The fact will be added by key to the props section of the message.
...
`<div class="padding">
	...
	<div class="col-md-4 m">
		<div data-jc="textbox" data-jc-path="key" data-jc-config="placeholder:@()" class="m">Key</div>
	</div>
</div>`;

...
exports.options = { light_ids: '', light_state: '', dim_level: 100, enabled: true, enable_disable: true, reset: true, debug: true, errors: false };
exports.readme = 
`# Action: Light
...
name	light_ids
type	[]string
doc	zero, one or more light IDs
default	
required	yes
valid values	
...
name	dim_level
type	number
doc	dim level as a percentage between 0 and 100
default	
required	yes
valid values	
`;
...
`<div class="padding">
	...
	<div class="row">
		<div class="col-md-4 m">
			<div data-jc="textbox" data-jc-path="light_ids" data-jc-config="placeholder:@()" class="m">Light Ids</div>
		</div>
	</div>	
	<div class="col-md-4 m">
		<div data-jc="textbox" data-jc-path="light_state" data-jc-config="placeholder:@()" class="m">Light State</div>
	</div>
	<div class="col-md-4 m">
		<div data-jc="textbox" data-jc-path="dim_level" data-jc-config="placeholder:100;type:number;increment:true" class="m">Dim Level</div>
	</div>
</div>`;

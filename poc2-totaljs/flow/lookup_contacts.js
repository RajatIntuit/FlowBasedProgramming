exports.id = 'lookup_contacts';
exports.title = 'LookupContacts';
...
exports.options = { email: '{}', phone: '{}', enabled: true, enable_disable: true, reset: true, debug: true, errors: false };
exports.readme = 
`# Condition: LookupContacts
Lookup contact info via profile service (email, phone) etc. for current location and inject it into the props section of the message before forwarding on out channel. Contact info can be provided as component parameters for testing.
...
name	email
type	[]object
doc	email contacts in NAE format
default	
required	no
valid values	
...
name	phone
type	[]object
doc	phone contacts in NAE format
default	
required	no
valid values	
`;
...
`<div class="padding">
	...
	<div class="col-md-4 m">
		<div data-jc="codemirror" data-jc-path="email" data-jc-config="placeholder:@({})" class="m">Email</div>
	</div>
	<div class="col-md-4 m">
		<div data-jc="codemirror" data-jc-path="phone" data-jc-config="placeholder:@({})" class="m">Phone</div>
	</div>
</div>`;

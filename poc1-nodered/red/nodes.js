...
*/
	function checkForIO() {
		...
		RED.nodes.eachNode(function (node) {
			console.log(node._def.category);

			if (node._def.category === "input-function" || node._def.category === "output-function" ||
				node._def.category === "trigger-function" || node._def.category === "condition-function" || 
				node._def.category === "action-function") {
				hasIO = true;
			}
		});
		return hasIO;
